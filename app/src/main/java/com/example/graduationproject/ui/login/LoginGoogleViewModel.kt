...
class LoginGoogleViewModel(private val tokenManager: TokenManager) : ViewModel() {


//    fun loginGoogle(onLoginResult: (Boolean, String) -> Unit) {
//        ApiManager.getApis().loginWithGoogle().enqueue(object : Callback<LoginGoogleResponse> {
