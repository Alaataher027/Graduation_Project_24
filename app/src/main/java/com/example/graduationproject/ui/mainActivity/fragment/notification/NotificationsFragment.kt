...
class NotificationsFragment : Fragment(R.layout.fragment_notifications),
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        notificationAdapter =
            NotificationAdapter(notificationsViewModel, userDataHomeViewModel, accessToken, this)

        binding.sellerReView.layoutManager = LinearLayoutManager(requireContext())
        binding.sellerReView.adapter = notificationAdapter

        binding.customerReView.layoutManager = LinearLayoutManager(requireContext())
        binding.customerReView.adapter = notificationAdapter

        // Determine user type and set visibility
        val userType = tokenManager.getUserType()
        if (userType == "Seller") {
            binding.sellerReView.visibility = View.VISIBLE
            binding.customerReView.visibility = View.GONE
        } else if (userType == "Customer") {
            binding.sellerReView.visibility = View.GONE
            binding.customerReView.visibility = View.VISIBLE
        }
