...
class EditProfileSellerViewModel : ViewModel() {
    ...
    fun updateEmail(
        ...
        ApiManager.getApisToken(accessToken).editSellerEmail(accessToken, email)
    ...
    fun updatePhoneNumber(
        ...
        ApiManager.getApisToken(accessToken).editSellerPhone(accessToken, phoneNumber)
            .enqueue(object : Callback<EditProfileResponse> {
                override fun onResponse(
                    call: Call<EditProfileResponse>,
                    response: Response<EditProfileResponse>
    ...
    fun updateGovernorate(
        ...
        ApiManager.getApisToken(accessToken).editSellerGovernorate(accessToken, governorate)
            .enqueue(object : Callback<EditProfileResponse> {
                override fun onResponse(
                    call: Call<EditProfileResponse>,
                    response: Response<EditProfileResponse>
    ...
    fun updateCity(
        ...
        ApiManager.getApisToken(accessToken).editSellerCity(accessToken, city)
            .enqueue(object : Callback<EditProfileResponse> {
                override fun onResponse(
                    call: Call<EditProfileResponse>,
                    response: Response<EditProfileResponse>
